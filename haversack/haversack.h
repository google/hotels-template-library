...
class Haversack {
 ...
 public:
  ...
  template <typename ExplicitWrappedType = void, internal::UncoercedCtorArg Arg>
  [[nodiscard]] Haversack Replace(Arg arg) && {
    ...
    using TypeToReplace = std::conditional_t<
        ...
        typename decltype(Traits()
                              ...
                              .template FindMatch(
                                  htls::meta::type_c<
                                      internal::CoercedCtorArg<Arg>>))::type,
        ExplicitWrappedType>;
    static_assert(
  ...
  [[nodiscard]] Haversack Replace(internal::UncoercedCtorArg auto arg) const& {
    Haversack self = *this;  // Make a copy of this.
